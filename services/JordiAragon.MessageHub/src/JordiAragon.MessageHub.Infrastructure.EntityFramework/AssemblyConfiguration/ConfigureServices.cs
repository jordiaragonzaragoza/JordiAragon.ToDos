namespace JordiAragon.MessageHub.Infrastructure.EntityFramework.AssemblyConfiguration
{
    using JordiAragon.MessageHub.Infrastructure.EntityFramework.Outbox;
