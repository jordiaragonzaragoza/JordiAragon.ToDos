namespace JordiAragonZaragoza.ToDos.Infrastructure.EntityFramework.AssemblyConfiguration
{
    using JordiAragonZaragoza.ToDos.Infrastructure.EntityFramework.Outbox;
