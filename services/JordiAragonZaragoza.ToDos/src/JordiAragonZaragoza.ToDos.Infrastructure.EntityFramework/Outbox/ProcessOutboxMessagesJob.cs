namespace JordiAragonZaragoza.ToDos.Infrastructure.EntityFramework.Outbox
{
    ...
    using ApplicationContractsAssemblyReference = JordiAragonZaragoza.ToDos.Application.Contracts.ApplicationContractsAssemblyReference;
