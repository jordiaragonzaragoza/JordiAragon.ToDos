namespace JordiAragonZaragoza.ToDos
{
    using Autofac;
    using Autofac.Extensions.DependencyInjection;
    using JordiAragonZaragoza.ToDos.Application.AssemblyConfiguration;
    using JordiAragonZaragoza.ToDos.Application.Contracts.AssemblyConfiguration;
    using JordiAragonZaragoza.ToDos.Domain.AssemblyConfiguration;
    using JordiAragonZaragoza.ToDos.Infrastructure.AssemblyConfiguration;
    using JordiAragonZaragoza.ToDos.Infrastructure.EntityFramework;
    using JordiAragonZaragoza.ToDos.Infrastructure.EntityFramework.AssemblyConfiguration;
    using JordiAragonZaragoza.ToDos.Presentation.IntegrationMessages.AssemblyConfiguration;
    using JordiAragonZaragoza.ToDos.Presentation.WebApi.AssemblyConfiguration;
