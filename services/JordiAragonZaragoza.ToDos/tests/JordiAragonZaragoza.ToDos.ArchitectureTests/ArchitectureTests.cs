namespace JordiAragonZaragoza.ToDos.ArchitectureTests
{
    using FluentAssertions;
    using JordiAragon.SharedKernel;
    using JordiAragon.SharedKernel.Domain.Contracts;
    using JordiAragonZaragoza.ToDos.Application;
    using JordiAragonZaragoza.ToDos.Application.Contracts;
    using JordiAragonZaragoza.ToDos.Domain;
    using JordiAragonZaragoza.ToDos.Infrastructure;
    using JordiAragonZaragoza.ToDos.Infrastructure.EntityFramework;
    using JordiAragonZaragoza.ToDos.Presentation.WebApi;
    using JordiAragonZaragoza.ToDos.Presentation.WebApi.Contracts.V1;
