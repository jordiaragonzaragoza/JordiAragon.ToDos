namespace JordiAragon.ToDos.ArchitectureTests
{
    using FluentAssertions;
    using JordiAragon.SharedKernel;
    using JordiAragon.SharedKernel.Domain.Contracts;
    using JordiAragon.ToDos.Application;
    using JordiAragon.ToDos.Application.Contracts;
    using JordiAragon.ToDos.Domain;
    using JordiAragon.ToDos.Infrastructure;
    using JordiAragon.ToDos.Infrastructure.EntityFramework;
    using JordiAragon.ToDos.Presentation.WebApi;
    using JordiAragon.ToDos.Presentation.WebApi.Contracts.V1;
